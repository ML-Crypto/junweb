...
const productsData = {
    ...
    'precision-cleaner': {
        title: '三槽式超音波清洗設備',
        description: '<strong>一機完成清洗、浸洗、蒸洗流程</strong><br>• 三槽式配置可同時進行超音波清洗、浸洗、蒸洗，流程完整、效率穩定。<br><br><strong>獨立槽體設計，避免交叉汙染</strong><br>• 三槽相互獨立，可搭配溢流漂洗、過濾循環與純水系統，保持清洗液長時間穩定潔淨。<br><br><strong>體積精巧、空間好規劃</strong><br>• 相較多槽大型設備，三槽式占地小，適合中小型工廠或產線局部改善使用。',
        images: ['images/portfolio/2-1三槽式超音波清洗設備.jpeg', 'images/portfolio/2-2三槽式超音波清洗設備.jpeg', 'images/portfolio/2-3三槽式超音波清洗設備.jpeg'],
    ...
    'industrial-cleaner': {
        ...
        images: ['images/portfolio/3-1五槽式超音波清洗設備.jpeg', 'images/portfolio/3-2五槽式超音波清洗設備.jpeg'],
    ...
    'lab-cleaner': {
        ...
        images: ['images/portfolio/4-1船型超音波清洗設備.jpeg', 'images/portfolio/4-2船型超音波清洗設備.jpeg'],
    ...
    'medical-cleaner': {
        ...
        images: ['images/portfolio/5-1溶劑蒸餾回收機.jpeg', 'images/portfolio/5-2溶劑蒸餾回收機.jpeg'],
    ...
    'jewelry-cleaner': {
        title: '超音波發振機及振動鈑',
        description: '<strong>超音波發振機（Generator）</strong><br><br><strong>高效能輸出</strong><br>• 提供穩定高頻交流電，驅動振動板產生超音波震動。<br>• 可精準調整功率與頻率，適應不同清洗需求。<br><br><strong>振動板 / PZT 震盪子（Transducer）</strong><br><br><strong>高效轉換能量</strong><br>• 將電能精準轉換為機械超音波震動，產生微氣泡空化效應，提升清洗效果。',
        images: ['images/portfolio/6-1超音波發振機及振動鈑.jpeg', 'images/portfolio/6-2超音波發振機及振動鈑.jpeg'],
    ...
    'large-industrial': {
        title: '治具碳化清潔爐',
        description: '<strong>高效碳化去汙</strong><br>• 利用高溫熱處理，快速分解工件表面油脂、樹脂與碳化物，還原治具潔淨度。<br><br><strong>精準溫控</strong><br>• 配備智能溫控系統，可設定多段加熱曲線，確保清潔效果穩定一致。<br><br><strong>均勻加熱設計</strong><br>• 爐內採循環對流或多區加熱，使熱能分布均勻，避免局部過熱或清潔不完全。<br><br><strong>適用多種治具與工件</strong><br>• 適合五金治具、電子夾具、模具與加工零件，提升二次加工與維護效率。',
        images: [
            'images/portfolio/7-1治具碳化清潔爐.jpeg',
            'images/portfolio/7-2治具碳化清潔爐.jpeg',
            'images/portfolio/7-3治具碳化清潔爐.jpeg',
            'images/portfolio/7-4治具碳化清潔爐.jpeg',
            'images/portfolio/7-5治具碳化清潔爐.jpeg'
        ],
    ...
    'smart-control': {
        title: '自動化超音波清洗設備',
        description: '<strong>全自動搬運與流程控制</strong><br>• 透過機械手臂、天車或升降搬運模組，自動完成清洗、漂洗、烘乾，提升效率並降低人工誤差。<br><br><strong>製程一致性高</strong><br>• 以 PLC 控制時間、溫度、超音波功率等關鍵參數，確保每批產品清洗品質一致。<br><br><strong>降低人力成本、提升產能</strong><br>• 自動化搬運與連續式作業模式，使清洗效率提升 20～50%，適合大量產線。',
        images: ['images/portfolio/8-1自動化超音波清洗設備.jpeg', 'images/portfolio/8-2自動化超音波清洗設備.jpeg'],
    ...
    'precision-parts': {
        ...
        images: ['images/portfolio/9-1純水過濾設備.jpeg', 'images/portfolio/9-2純水過濾設備.jpeg'],
    ...
    'explosion-proof-pump': {
        ...
        images: ['images/portfolio/11-1美製原裝氣動防爆桶裝專用泵浦.jpeg', 'images/portfolio/11-2美製原裝氣動防爆桶裝專用泵浦.jpeg', 'images/portfolio/11-3美製原裝氣動防爆桶裝專用泵浦.jpeg'],
    ...
    'cooling-tower-cleaner': {
        title: '冷卻塔管路清洗機',
        description: '<strong>高效管路清洗</strong><br>• 專為冷卻塔及工業管路設計，可快速去除水垢、鐵鏽、藻類及沉積物，恢復管路流量與效率。<br><br><strong>全程自動化操作</strong><br>• 配備泵浦與循環系統，自動控制清洗流程與壓力，降低人工操作負擔。<br><br><strong>提升冷卻效率與設備壽命</strong><br>• 定期清洗管路，可維持冷卻效率，減少能源浪費並延長冷卻塔及設備使用壽命。',
        images: ['images/portfolio/12-1冷卻塔管路清洗機.jpeg', 'images/portfolio/12-2冷卻塔管路清洗機.jpeg'],
    ...
    'hot-air-oven': {
        ...
        images: ['images/portfolio/13-1熱風循環烘烤爐.jpeg', 'images/portfolio/13-2熱風循環烘烤爐.jpeg'],
    ...
    'ultrasonic-solvents': {
        ...
        images: [
            'images/portfolio/14-1 各式超音波清洗溶劑.jpeg',
            'images/portfolio/14-2 各式超音波清洗溶劑.jpeg', 
            'images/portfolio/14-3 各式超音波清洗溶劑.jpeg'
        ],
